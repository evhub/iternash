...
`Agent(name, actor, default=<object object at 0x000002036DF5DA40>, period=1, debug=False)`
:   Agent class.
    ...
    `clone(self, name=None, actor=None, default=<object object at 0x000002036DF5DA50>, period=None)`
