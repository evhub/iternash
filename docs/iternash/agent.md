...
`hist_agent(name, record_var, maxhist=None, copy_func=<function deepcopy at 0x0000018E42D64BF8>, initializer=(), **kwargs)`
...
`Agent(name, actor, default=<object object at 0x0000018E5D73F0B0>, period=1, extra_defaults={}, copy_func=None, debug=False)`
:   Agent class.
    ...
    `clone(self, name=None, actor=None, default=<object object at 0x0000018E5D73F0C0>, period=None, extra_defaults=None, copy_func=<object object at 0x0000018E5D73F0C0>, debug=None)`
