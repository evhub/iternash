...
`Agent(name, actor, default=<object object at 0x00000129907FA220>, period=1, debug=False)`
:   Agent class.
    ...
    `clone(self, name=None, actor=None, default=<object object at 0x00000129907FA230>, period=None)`
