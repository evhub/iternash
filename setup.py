...
setuptools.setup(name="iternash", version="0.0.1", url="https://github.com/evhub/iternash", author="Evan Hubinger", packages=setuptools.find_packages(), requirements=["tqdm",])
